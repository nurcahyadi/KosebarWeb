...
<form   action="{{route('logout')}}" method="post">
  ...
  <button type="submit" class="btn btn-danger square-btn-adjust">Logout</button>
          ...
          <tbody>
                    ...
                    <li>
                        <a class="active-menu"  href="{{route('admin.index')}}"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                    ...
                    <li>
                       ...
                       <a  href="{{route('profileadmin.show',['profileadmin'=>Auth::user()->id])}}"><i class="fa fa-desktop fa-3x"></i>Profile</a>
                    ...
                    <li>
                        <a  href="{{route('admin.index')}}"><i class="fa fa-qrcode fa-3x"></i>Daftar Penjual</a>
                    </li>
